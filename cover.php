<!DOCTYPE html>
<html>
<body style="background-image:url(https://cdn-b.medlife.com/2018/01/10-best-government-hospitals-in-mumbai.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/rs.png" width="30px" height="30px"><strong> Healthify </strong>Appointment Booking System</a></li>
